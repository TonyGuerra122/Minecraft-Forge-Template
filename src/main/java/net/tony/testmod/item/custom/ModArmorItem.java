...
import net.tony.testmod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    ...
    private static final Map<ArmorMaterial, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP = new ImmutableMap.Builder<ArmorMaterial, List<MobEffectInstance>>()
            .put(ModArmorMaterials.SAPPHIRE, List.of(
                    new MobEffectInstance(MobEffects.ABSORPTION, 200, 1, false, false, true),
                    new MobEffectInstance(MobEffects.REGENERATION, 200, 1, false, false, true) // Adicione outro efeito aqui
            ))
            .build();
