...
public class RhinoRenderer extends MobRenderer<RhinoEntity, RhinoModel<RhinoEntity>>{
    ...
    @Override
    public ResourceLocation getTextureLocation(RhinoEntity p_115812_) {
        return new ResourceLocation(TestMod.MOD_ID, "textures/entity/rhino.png");
    }    


    @Override
    public void render(RhinoEntity pEntity, float pEntityYaw, float pParticalTicks, PoseStack pMatrixStack,
